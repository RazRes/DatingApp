...
public class MessageRepository(AppDbContext context) : IMessageRepository
{
    ...
    public async Task<PaginatedResult<MessageDto>> GeteMessagesFroMember(MessageParams messageParams)
    {
        ...
        {
            "Outbox" => query.Where(x => x.SenderId == messageParams.MemberId && x.SendereDeleted == false),
    ...
    public async Task<IReadOnlyList<MessageDto>> GetMessageThread(string currentMemberId, string recipientId)
    {
        ...
        return await context.Messages.Where(x => (x.RecipientId == currentMemberId && x.RecipientDeleted == false && x.SenderId == recipientId)
        || (x.SenderId == currentMemberId && x.SendereDeleted == false && x.RecipientId == recipientId))
